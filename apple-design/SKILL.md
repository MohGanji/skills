...
Adapted from [emilkowalski/skills](https://github.com/emilkowalski/skills/tree/main/skills). Distilled from Apple's WWDC design talks — chiefly *Designing Fluid Interfaces* (WWDC 2018) — and translated to the web platform.
