...
| [startup-priorities](startup-priorities/) | Score feature priorities using Geoff Ralston's (b×d)/c formula — Breadth, Depth, and Cost on 1-5 scales yielding a 1-100 priority score. Outputs a standard one-liner for use in issue trackers and planning docs. | `prioritization`, `planning`, `product` |
